<?php
    ...
    $sql = "SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'sistema_medico' AND TABLE_NAME = 'medico';";
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container">
        ...
        <form action="insMedico.php" method="POST" class="row g-3 needs-validation mb-3" novalidate>
            <div class="col-md-1">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="frmCrm" name="frmCrm" required>
                <div class="valid-feedback">
                    Parece bom!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="frmEspecialidade" name="frmEspecialidade" required>
                <div class="valid-feedback">
                    Parece bom!
                </div>
                <div class="invalid-feedback">
