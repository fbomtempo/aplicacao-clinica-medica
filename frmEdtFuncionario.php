...
<body class="d-flex flex-column h-100">
    ...
    <div class="container">
        ...
        <form action="edtFuncionario.php" method="POST" class="row g-3 needs-validation mb-3" novalidate>
            <div class="col-md-1">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="frmCep" name="frmCep" maxlength="9" value="<?php echo $cep ?>" required>
                <div class="valid-feedback">
                    Parece bom!
                </div>
                <div class="invalid-feedback">
