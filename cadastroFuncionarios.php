        ...
        <div class="row">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-9 col-sm-12 col-xs-12 pt-md-0 pt-3">
                <form action="cadastroFuncionarios.php" method="GET" class="d-flex">
                    ...
                    <button class="btn-limpar pesquisar ms-2" type="button" onclick="JavaScript:location.href='cadastroFuncionarios.php'">Limpar</i></button>
                </form>
            </div>
        </div>
        <br>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <span class="pe-1"><button class="botao-pequeno editar" onclick="JavaScript:location.href='frmEdtFuncionario.php?codigo=' + 
                                <?php echo $funcionario['codigo']; ?>"><i class="fas fa-edit"></i></button></span>

                                <span class="pe-1"><button class="botao-pequeno deletar" onclick="JavaScript:location.href='frmRmvFuncionario.php?codigo=' + 
                                <?php echo $funcionario['codigo']; ?>"><i class="fas fa-trash-alt"></i></button></span>

                                <button class="botao-pequeno visualizar" onclick="JavaScript:location.href='frmVisFuncionario.php?codigo=' + 
                                <?php echo $funcionario['codigo']; ?>"><i class="fas fa-eye"></i></i></button>
                            </td>
                        </tr>
                    <?php
                    }
